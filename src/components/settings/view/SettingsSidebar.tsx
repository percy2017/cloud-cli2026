import { Bell, Bot, GitBranch, Info, Key, ListChecks, Mic, MonitorPlay, Palette, Puzzle, Sparkles } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'minimax', labelKey: 'mainTabs.minimax', icon: Sparkles },
