      ...
      <div className="w-full max-w-md rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
        <div className="flex items-center justify-between border-b border-gray-200 p-6 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t('createTaskModal.title')}</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6 p-6">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">{t('createTaskModal.proTip')}</h4>
                <p className="mb-3 text-sm text-blue-800 dark:text-blue-200">{t('createTaskModal.description')}</p>
                <div className="rounded border border-blue-200 bg-white p-3 dark:border-blue-700 dark:bg-gray-800">
                  <p className="mb-1 text-xs font-medium text-gray-600 dark:text-gray-400">{t('createTaskModal.exampleLabel')}</p>
                  <p className="font-mono text-sm text-gray-900 dark:text-white">{t('createTaskModal.examplePrompt')}</p>
                </div>
              </div>
            </div>
          </div>
