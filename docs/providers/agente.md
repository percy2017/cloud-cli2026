...
| `qwen` | Qwen Code CLI (subprocess + `--output-format stream-json`, NDJSON) | **Production** (v0.19.8 verified live with `MiniMax-M3` proxy) | ✅ **Tested by user** | [qwen.md](./qwen.md) |
